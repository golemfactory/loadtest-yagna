...
from utils import launch_image, extract_instance_index
...
class GolemBaseUser(FastHttpUser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.id = 0
        try:
            self.instance_index = extract_instance_index()
        except ValueError as e:
            logging.warning(f"Could not extract instance index from hostname: {e}")
